...
class SampleBase(object):
    def __init__(self, *args, **kwargs):
        ...
        # or RGB nondefault parameters  --led-rows=32 --led-cols=32 --led-chain=2 --led-multiplexing=2
        # amended by Kostya 
        ...
        self.parser.add_argument("--led-multiplexing", action="store", help="Multiplexing type: 0=direct; 1=strip; 2=checker; 3=spiral; 4=ZStripe; 5=ZnMirrorZStripe; 6=coreman; 7=Kaler2Scan; 8=ZStripeUneven... (Default: 0)", default=2, type=int)
